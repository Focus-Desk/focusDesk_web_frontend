...
const cardData: CardData[] = [
  ...
  },
  {
    ...
    gradient: "bg-gradient-to-br from-orange-300 to-amber-500",
  },
  {
    title: "Focus Mode",
  ...
  },
  {
    ...
    gradient: "bg-gradient-to-br from-purple-300 to-indigo-500",
  },
  {
    title: "Contact Us",
  ...
  //   link: "#plans",
  //   image: "/more.png",
  //   // Spans 2 columns to fill gaps
  //   className: "col-span-1 md:col-span-2",
  //   gradient: "bg-gradient-to-br from-pink-300 to-rose-500",
  // },
];
